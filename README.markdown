...
<tr><td> ReferenceOne(weak=false):  </td><td>Refers to a document. The default is a weak reference. By optionaly specifying weak=false you get a hard reference.</td></tr>
<tr><td> ReferenceMany(weak=false): </td><td>Same as ReferenceOne except that you can refer many documents with the same reference type(weak or not).</td></tr>
