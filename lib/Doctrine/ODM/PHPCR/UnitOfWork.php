...
class UnitOfWork
{
     ...
     * @var array
     */
    private $originalTranslatedData = [];
     ...
     * @param bool          $fallback Whether to do try other languages
     * @param bool          $refresh
     *
     * @throws MissingTranslationException if the translation in $locale is not
     *                                     found and $fallback is false
