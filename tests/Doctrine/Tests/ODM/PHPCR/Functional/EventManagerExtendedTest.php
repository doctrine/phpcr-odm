...
class EventManagerExtendedTest extends \Doctrine\Tests\ODM\PHPCR\PHPCRFunctionalTestCase
{
    ...
    {
        $page = new \Doctrine\Tests\Models\CMS\CmsPage();
        $page->title = "my-page";
        ...
        $item = new \Doctrine\Tests\Models\CMS\CmsItem();
        $item->name = "my-item";
...
class TestPersistenceListener
{
    ...
    public function prePersist(EventArgs $e)
    {
        ...
        if($document instanceof \Doctrine\Tests\Models\CMS\CmsPage){
            $this->pagePrePersist = true;
        } else if($document instanceof \Doctrine\Tests\Models\CMS\CmsItem){
