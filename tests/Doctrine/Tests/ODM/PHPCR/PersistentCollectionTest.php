...
/**
 * Straight from \Doctrine\Tests\Common\Collections\CollectionTest with minor adaptions
 */
class PersistentCollectionTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var PersistentCollectionProxy
     */
    private $_coll;

    protected function setUp()
    {
        $this->_coll = new PersistentCollectionProxy;
    }

    public function testChanged()
    {
        $this->_coll->clear();
        $this->assertTrue($this->_coll->changed());
    }

    public function testTakeSnapshot()
    {
        $this->_coll->changed = true;
        $this->_coll->takeSnapshot();
        $this->assertFalse($this->_coll->changed());
    }
    ...
    public function testUnwrap()
    {
        ...
        $uw = $this->_coll->unwrap();
        $this->assertInstanceOf('Doctrine\Common\Collections\ArrayCollection', $uw);
    }
...
class PersistentCollectionProxy extends PersistentCollection
{
    public $changed;
    ...
    {
        if (null === $this->col) {
            $this->col = new \Doctrine\Common\Collections\ArrayCollection;
        }
    }
